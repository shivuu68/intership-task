...
questions = ["1 + 7 = ?","2 + 2 = ?","3 + 3 = ?","4 + 4 = ?","5 + 5 = ?"]
options = [['8','3','2','5','2'],['5','4','3','5','4'],
           ['10','3','5','6','6'],['8','6','4','5','8'],['3','10','6','8','10']]


frame = tk.Frame(root, padx=10, pady=10,bg='#fff')
question_label = tk.Label(frame,height=6, width=30,bg='black',fg="#fff", 
